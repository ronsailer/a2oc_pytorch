	...
	def train(self):
		...
		while self.num_moves.value < self.args.max_num_frames:
			if done:
				...
				print "id: {}\t reward: {}\t moves: {}\t marginal moves: {}\t\t %.2f%%".format(self.id_num,
				                                                                               total_reward,
...
def parse_params():
	...
	parser.add_argument('--resume-if-exists', type=str2bool,
	                    default=False)  # for server that kills and restarts processes
